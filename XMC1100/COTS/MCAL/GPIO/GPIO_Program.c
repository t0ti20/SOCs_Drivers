...
GPIO_Error_t GPIO_Read_Port_Value(GPIO_Port_t Ptr_GPIO_Port_tPort,u16 *Ptr_u16Value)
{
     ...
     if((Ptr_GPIO_Port_tPort>=GPIO_Port_0)&&(Ptr_GPIO_Port_tPort<=GPIO_Port_2))
     {
          ...
          switch (Ptr_GPIO_Port_tPort)
          {
               ...
               case GPIO_Port_0:*Ptr_u16Value=(u16)(PORT0->Pn_IN.Register);break;
               /*Read Data For Port 1*/
               case GPIO_Port_1:*Ptr_u16Value=(u16)(PORT1->Pn_IN.Register);break;
               /*Read Data For Port 2*/
               case GPIO_Port_2:*Ptr_u16Value=(u16)(PORT2->Pn_IN.Register);break;
          }
     }
...
/*Configure Pin Value By Just Write Ticnique*/
               ...
               if(Copy_GPIO_Output_tState==GPIO_Output_Hi){Ptr_PORTX_tPortX->Pn_OMR.Register=(u32)(ONE<<Ptr_GPIO_Pin_Config_tPin->Pin);}
               else if(Copy_GPIO_Output_tState==GPIO_Output_Low){Ptr_PORTX_tPortX->Pn_OMR.Register=(u32)(ONE<<((Ptr_GPIO_Pin_Config_tPin->Pin)+16));}
               else if(Copy_GPIO_Output_tState==GPIO_Output_Toggle){Ptr_PORTX_tPortX->Pn_OMR.Register=(u32)((ONE<<((Ptr_GPIO_Pin_Config_tPin->Pin)+16))|(ONE<<(Ptr_GPIO_Pin_Config_tPin->Pin)));}
