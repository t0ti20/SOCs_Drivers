...
typedef enum {TMR_Normal=1,PWM_Phase_Correct,CTC,Fast_PWM}Timer_Modes;
typedef enum {Timer_0,Timer_1,Timer_2}Timers;
typedef enum {TMR_Pre_Scalar_0,TMR_Pre_Scalar_8,TMR_Pre_Scalar_32,TMR_Pre_Scalar_64,TMR_Pre_Scalar_128,TMR_Pre_Scalar_256,TMR_Pre_Scalar_1024}TMR_Pre_Scalar;
#endif
